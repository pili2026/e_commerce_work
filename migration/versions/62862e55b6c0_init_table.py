...
Revision ID: 62862e55b6c0
Revises: 
Create Date: 2024-07-20 01:15:08.699093
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("user_id", sa.UUID(), nullable=False),
        sa.Column("status", sa.Enum("DONE", "PROCESSING", "CANCELLED", name="order_status_enum"), nullable=False),
        sa.Column("created_at", postgresql.TIMESTAMP(precision=3), nullable=False),
        sa.Column("updated_at", postgresql.TIMESTAMP(precision=3), nullable=False),
